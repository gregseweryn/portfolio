      ...
      blocks: [
        ...
        },
        {
          ...
          body: [
            ...
            "The indices are conceptually close to the outcome: a general attitude towards tourism is not far from an assessment of its costs and benefits. The model therefore demonstrates the internal consistency of the theoretical frame, confirming that the exchange model hangs together, rather than uncovering a surprising predictive relationship.",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          translation:
            "It genuinely hurts when you go out for bread and find the bread shop isn't there any more.",
          speaker: "Bartek",
